...
int main(int argc, char* argv[]){
	...
	char actual[53] = "/sys/class/backlight/10-0054/actual_brightness";
	char max[50] = "/sys/class/backlight/10-0054/max_brightness";
  	char bright[46] = "/sys/class/backlight/10-0054/brightness";
